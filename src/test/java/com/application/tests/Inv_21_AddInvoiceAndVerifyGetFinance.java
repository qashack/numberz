...
public class Inv_21_AddInvoiceAndVerifyGetFinance extends BaseClass {
	...
	String username = ExcelLibrary.getExcelData(filePath_invoice, sheetName, 1, 10);
	String password = ExcelLibrary.getExcelData(filePath_invoice, sheetName, 1, 11);
	int k = 0;
	...
	public void addInvoiceExCustomer() {
		...
		email.verifyGetFianance(k);
	}

	private void checkEmailOption() {
		GenericUtils.delay(30);
