...
public class EXP_18_AddARecurringBillForDifferentFrequencies extends BaseClass{

	String expensesSheet = "EXP_18";

	@Test(description = "Add a Recurring Bill for different frequencies")
	public void addARecurringBillForDifferentFrequencies() {
